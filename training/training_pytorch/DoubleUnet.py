...
class encoder1(nn.Module):
    def __init__(self):
        super().__init__()
        self.network = vgg19(pretrained=True)
        self.network.features[0] = nn.Conv2d(1, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
      
        self.x1 = self.network.features[:4]
        self.x2 = self.network.features[4:9]
        self.x3 = self.network.features[9:18]
        self.x4 = self.network.features[18:27]
        self.x5 = self.network.features[27:36]
